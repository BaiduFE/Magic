...
test("default params", function(){
	...
	equals(dialog.height, dialog.getElement().clientHeight, "The height is right");
	equals(dialog.width, dialog.getElement().clientWidth, "The width is right");
...
test("all params", function(){
	...
	equals(dialog.getElement("titleText").textContent, "标题", "The titleText is right");
	equals(dialog.getElement("content").firstChild.id, "cdiv", "The content is right");
	document.body.removeChild(baidu.dom.g("one-dialog"));
});
...
test("center, auto width & height", function(){
	...
	ua.frameExt(function(w, f){
		...
		equals(dialog.top, 25, "The top is right");
		equals(dialog.getElement().style.left, "100px", "The left is right");
		equals(dialog.getElement().style.top, "25px", "The top is right");
